...
public final class GoogleMapsUtilities {
    ...
    public static void getAndDrawPath(Context context, GoogleMap googleMap, LatLng from, LatLng to, boolean byCar) {

        String url = getDirectionsUrl(from, to, byCar);
        DownloadTask downloadTask = new DownloadTask(context, googleMap);
    ...
    private static class DownloadTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                String distanceAndTime = timeOb.getString("text") + " " + distOb.getString("text");
...
//                Toast.makeText(context, distanceAndTime, Toast.LENGTH_LONG).show();
    ...
    public static void zoomAndFitLocations(GoogleMap googleMap, LatLng... latLogs) {
        try {
